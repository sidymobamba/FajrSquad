...
namespace FajrSquad.Infrastructure.Migrations
{
    ...
    [Migration("20251203130036_AddAdhkarTables")]
    partial class AddAdhkarTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FajrSquad.Core.Entities.Adhkar.UserAdhkarFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserAdhkarFavorites", (string)null);
                });
            ...
            modelBuilder.Entity("FajrSquad.Core.Entities.Adhkar.UserAdhkarProgress", b =>
                {
                    ...
                    b.HasIndex("UserId", "AdhkarId", "Date")
                        .IsUnique()
                        .HasDatabaseName("IX_UserAdhkarProgress_User_Adhkar_Date");

                    b.ToTable("UserAdhkarProgress", (string)null);
                });

            modelBuilder.Entity("FajrSquad.Core.Entities.Adhkar.UserAdhkarStats", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserAdhkarStats", (string)null);
                });
